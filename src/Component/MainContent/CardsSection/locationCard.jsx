  ...
  return (
    <div className="main-content__showing-cards__card">
      <div
        ...
        className="main-content__showing-cards__card__like-container"
      >
        {likeState ? (
      ...
      <Link to={`/rooms/${locationState}/${cardsData["id"]}`}>
        <div className="main-content__showing-cards__card__img-container">
          ...
          >
            {Object.entries(cardsData["img-url"]).map(([index, img]) => (
              <SwiperSlide
                key={index}
                className="main-content__showing-cards__card__img-container__swiper__slide"
              >
                <img
